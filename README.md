...
running command...
$ corev3 (--version)
@oclif/plugin-test-core-v3/0.1.14 linux-x64 node-v18.20.3
$ corev3 --help [COMMAND]
USAGE
  $ corev3 COMMAND
...
...
_See code: [src/commands/core-v3.ts](https://github.com/oclif/plugin-test-core-v3/blob/0.1.14/src/commands/core-v3.ts)_
...
_See code: [src/commands/hello/index.ts](https://github.com/oclif/plugin-test-core-v3/blob/0.1.14/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/oclif/plugin-test-core-v3/blob/0.1.14/src/commands/hello/world.ts)_
